...
const Features = () => {
    return (
        <>
            <section className="py-6 bg-light-primary my-5">
                <div className="container">
                    <div className="row justify-content-center text-center mb-4">
                        <div className="col-xl-6 col-lg-8 col-sm-10">
                            <h2 className="font-weight-bold">The Perfect Blend of Features <br />for your Company</h2>
                            <p className="text-muted mb-0">We bring the results while helping you achieve cost and time savings without taking on risk or management overhead.</p>
                        </div>
                    </div>
                        ...
                        <div className="col my-3">
                            <div className="card border-hover-primary hover-scale">
                                <div className="card-body">
                                    ...
                                    <h6 className="font-weight-bold mb-3">Search Engine Optimization</h6>
                                    <p className="text-muted mb-0">Embed holistics charts directly to your application</p>
                                </div>
                            </div>
                        </div>
                        <div className="col my-3">
                            <div className="card border-hover-primary hover-scale">
                                <div className="card-body">
                                    ...
                                    <h6 className="font-weight-bold mb-3">Website and Landing Page</h6>
                                    <p className="text-muted mb-0">Embed holistics charts directly to your application</p>
                                </div>
                            </div>
                        </div>
